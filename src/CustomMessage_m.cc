...
CustomMessage::CustomMessage(const char *name, short kind) : ::omnetpp::cMessage(name, kind)
{
}

CustomMessage::CustomMessage(const CustomMessage& other) : ::omnetpp::cMessage(other)
{
    copy(other);
}
...
void CustomMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->otp);
}

const char * CustomMessage::getContent() const
{
    return this->content.c_str();
}

void CustomMessage::setContent(const char * content)
{
    this->content = content;
}

const char * CustomMessage::getOtp() const
{
    return this->otp.c_str();
}

void CustomMessage::setOtp(const char * otp)
{
    this->otp = otp;
}
...
CustomMessageDescriptor::CustomMessageDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(CustomMessage)), "omnetpp::cMessage")
{
...
int CustomMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "otp") == 0) return baseIndex + 1;
...
std::string CustomMessageDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_otp: return oppstring2string(pp->getOtp());
        default: return "";
    }
}
...
void CustomMessageDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_otp: pp->setOtp((value)); break;
...
omnetpp::cValue CustomMessageDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_otp: return pp->getOtp();
...
void CustomMessageDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_otp: pp->setOtp(value.stringValue()); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'CustomMessage'", field);
    }
}
